    ...
    (0, _createClass3.default)(Style, [{
        ...
        value: function addCommandsForDelete(cmdGroup) {
            ...
            try {
                for (var _iterator3 = (0, _getIterator3.default)(elements), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    ...
                    if ((element.getElementType() === DocElement.type.text || element.getElementType() === DocElement.type.tableText) && element.getValue('styleId') && utils.convertInputToNumber(element.getValue('styleId')) === this.id) {
        ...
        value: function setBorderValue(obj, field, fieldPrefix, value, rb) {
            ...
            if (fieldWithoutPrefix === 'borderAll') {
                var borderLeftField = fieldPrefix + "borderLeft";
                var borderTopField = fieldPrefix + "borderTop";
                var borderRightField = fieldPrefix + "borderRight";
                var borderBottomField = fieldPrefix + "borderBottom";
                if (value !== obj[borderLeftField]) {
                    obj[borderLeftField] = value;
                    rb.notifyEvent(obj, _Command2.default.operation.change, borderLeftField);
                }
                if (value !== obj[borderTopField]) {
                    obj[borderTopField] = value;
                    rb.notifyEvent(obj, _Command2.default.operation.change, borderTopField);
                }
                if (value !== obj[borderRightField]) {
                    obj[borderRightField] = value;
                    rb.notifyEvent(obj, _Command2.default.operation.change, borderRightField);
                }
                if (value !== obj[borderBottomField]) {
                    obj[borderBottomField] = value;
                    rb.notifyEvent(obj, _Command2.default.operation.change, borderBottomField);
                }
            } else if (fieldWithoutPrefix === 'borderLeft' || fieldWithoutPrefix === 'borderTop' || fieldWithoutPrefix === 'borderRight' || fieldWithoutPrefix === 'borderBottom') {
                ...
                try {
                    for (var _iterator3 = (0, _getIterator3.default)(obj.getErrors()), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        ...
                        if (_propertyDescriptor) {
                            var rowId = this.idPrefix + '_' + _propertyDescriptor.fieldId + '_row';
...
var TableTextElement = function (_TextElement) {
    ...
    (0, _createClass3.default)(TableTextElement, [{
        ...
        key: 'getProperties',
        value: function getProperties() {
            var fields = ['width', 'content', 'eval', 'colspan', 'styleId', 'bold', 'italic', 'underline', 'strikethrough', 'horizontalAlignment', 'verticalAlignment', 'textColor', 'backgroundColor', 'font', 'fontSize', 'lineSpacing', 'paddingLeft', 'paddingTop', 'paddingRight', 'paddingBottom', 'pattern', 'link', 'cs_condition', 'cs_styleId', 'cs_bold', 'cs_italic', 'cs_underline', 'cs_strikethrough', 'cs_horizontalAlignment', 'cs_verticalAlignment', 'cs_textColor', 'cs_backgroundColor', 'cs_font', 'cs_fontSize', 'cs_lineSpacing', 'cs_paddingLeft', 'cs_paddingTop', 'cs_paddingRight', 'cs_paddingBottom'];
            var tableBandObj = this.rb.getDataObject(this.parentId);
        ...
        value: function renderStyle(elPanel, idPrefix, fieldPrefix, renderDocElementMainStyle, rb) {
            ...
            var elBorderAll = $('<button id="rbro_' + idPrefix + 'border_all"\n             class="rbroButton rbroActionButton rbroIcon-border-all"\n             type="button" value="' + fieldPrefix + 'borderAll" title="' + rb.getLabel('styleBorderAll') + '"></button>').click(function (event) {
                ...
                for (var i = selectedObjects.length - 1; i >= 0; i--) {
                    var obj = selectedObjects[i];
                    cmdGroup.addSelection(obj.getId());
                    cmdGroup.addCommand(new _SetValueCmd2.default(obj.getId(), fieldPrefix + 'borderAll', val, _SetValueCmd2.default.type.button, rb));
                    ...
                    if (obj instanceof _DocElement2.default && obj.getValue(fieldPrefix + 'styleId') !== '') {
                        ...
                        obj.addCommandsForChangedProperty('borderAll', val, _SetValueCmd2.default.type.button, cmdGroup);
                    }
                }
                if (!cmdGroup.isEmpty()) {
                    rb.executeCommand(cmdGroup);
